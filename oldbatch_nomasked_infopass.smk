...
rule all:
    input:
        #qexpand("paneldir/{panel}-{level}.acf.gz", level=LEVEL, panel='euras.oldbatch.infopass'),
        expand("UKBiobank/selection_UKBV2/{panel}/Genscores-{level}-50_irnt.txt", level=LEVEL, panel='euras.oldbatch.infopass')
